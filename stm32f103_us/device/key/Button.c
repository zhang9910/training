...
//-------------------------------------------------------------------------------
// Key1 按键引脚
//#define GPIO_CLK_Key1			RCC_APB2Periph_GPIOC
#define GPIO_Pin_Key1			GPIO_PIN_5                  
#define GPIO_Mode_Key1		    GPIO_MODE_INPUT  
#define GPIO_Key1				GPIOC                    
#define Key1In					HAL_GPIO_ReadPin(GPIO_Key1, GPIO_Pin_Key1)	
//-------------------------------------------------------------------------------
// Key2 按键引脚
//#define GPIO_CLK_Key2			RCC_APB2Periph_GPIOA
#define GPIO_Pin_Key2			GPIO_PIN_15                  
#define GPIO_Mode_Key2			GPIO_MODE_INPUT  
#define GPIO_Key2				GPIOA                   
#define Key2In					HAL_GPIO_ReadPin(GPIO_Key2	, GPIO_Pin_Key2)
//-------------------------------------------------------------------------------
// Key3 按键引脚
//#define GPIO_CLK_Key3			RCC_APB2Periph_GPIOA
#define GPIO_Pin_Key3			GPIO_PIN_0               
#define GPIO_Mode_Key3			GPIO_MODE_INPUT  
#define GPIO_Key3				GPIOA                     
#define Key3In					HAL_GPIO_ReadPin(GPIO_Key3	, GPIO_Pin_Key3)		
/****************************************************************************************/
//用户添加自定义按键接口	
...
static void ButtonGpioInit(void)
{
	...
	//-------------------------------------------------------------------------------------------
	// 对应外设时钟与GPIO配置
	GPIO_InitStructure.Pin  = GPIO_Pin_Key1;					// IO口选择
	GPIO_InitStructure.Pull=GPIO_PULLUP;                        //上拉
	GPIO_InitStructure.Mode = GPIO_Mode_Key1;					// 配置模式
	HAL_GPIO_Init(GPIO_Key1, &GPIO_InitStructure);						// 使能
	//-------------------------------------------------------------------------------------------
	// 对应外设时钟与GPIO配置 
	GPIO_InitStructure.Pin  = GPIO_Pin_Key2;					// IO口选择
	GPIO_InitStructure.Pull=GPIO_PULLUP;                        //上拉
	GPIO_InitStructure.Mode = GPIO_Mode_Key2;					// 配置模式
	HAL_GPIO_Init(GPIO_Key2, &GPIO_InitStructure);						// 使能					
	//-------------------------------------------------------------------------------------------
	// 对应外设时钟与GPIO配置 
	GPIO_InitStructure.Pin  = GPIO_Pin_Key3;					// IO口选择
	GPIO_InitStructure.Pull=GPIO_PULLDOWN;                      //下拉
	GPIO_InitStructure.Mode = GPIO_Mode_Key3;					// 配置模式
	HAL_GPIO_Init(GPIO_Key3, &GPIO_InitStructure);						// 使能
	/****************************************************************************************/
	//用户添加自定义按键配置	
